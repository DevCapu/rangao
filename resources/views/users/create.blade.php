                    ...
                    <form action="{{route('users.store')}}" method="post">
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                <input placeholder="João da Silva" id="nome" type="text" class="validate" name="name"
                                       required>
                        ...
                        <div class="row">
                            ...
                            @enderror
                            <div class="input-field col s6">
                                <select name="objective" id="objetivo" required>
                            ...
                            @enderror
                            <div class="input-field col s6">
                                <select name="activity" id="atividade" required>
